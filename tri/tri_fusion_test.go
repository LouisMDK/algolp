...
func TestFusionVide(t *testing.T){
	var liste []int
...
func TestFusionVide2(t *testing.T){
	var liste []int = nil
	liste = TriFusion(liste)
	if len(liste) != 0 || liste != nil {
		t.Fail()
...
func TestFusionDejaTrie(t *testing.T) {
...
func TestFusionValeursNegatives(t *testing.T) {
...
func TestFusionUneValeur(t *testing.T) {
	var liste []int = []int{1}
	liste = TriFusion(liste)
...
func TestFusionPlusieursValeurs(t *testing.T) {
...
func TestFusionDoublons(t *testing.T) {
